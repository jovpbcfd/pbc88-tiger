...
export default function GamesJili() {
	return (
		<>
			<section
				id="jili-games"
				className="bg-[url(/img/hero-provider/PBC_JILI_MOB.webp)] bg-cover bg-no-repeat
        lg:bg-[url(/img/hero-provider/PBC_JILI_BG.png)]
        "
			>
			...
			<section className="bg-[url(/img/hero-provider/PBC_LAST_BG.png)] bg-no-repeat bg-cover">
