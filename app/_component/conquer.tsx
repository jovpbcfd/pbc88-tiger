			...
			<div className="md:mt-5">
				<div className="relative w-full p-0 md:p-6 md:mt-4">
					<div className="relative flex flex-col w-full">
						<div className="hidden absolute top-0 bottom-0 left-[50%] w-[2px] bg-[#27DD12] lg:flex"></div>
						{data.map((step) => (
							<motion.div
								key={step.id}
								className={cn(
								...
								<div className="hidden relative lg:flex lg:flex-col lg:items-center lg:my-auto w-[10%]">
									<div
										className={cn(
											...
											activeStep === step.tag
												? "bg-[#27DD12] text-white border-[#27DD12] font-bold"
												: "bg-[#27DD12]/90 text-white/90 border-[#27DD12]"
										)}
									></div>
								</div>
