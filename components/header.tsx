...
export default function Header() {
	...
	return (
		<header
			className={`bg-[#163812] transition-all duration-300 ease-in-out ${
		...
		>
			...
			<motion.div
				className={`bg-[linear-gradient(180deg,#163812_0%,#28B849_100%)] transition-shadow duration-300 shadow-lg ${
					isSticky ? "shadow-lg" : ""
				}`}
			>
              ...
              >
                SIGNUP
							...
							<Link
								href="#"
								className="bg-[linear-gradient(135deg,#28B849_0%,#26621E_100%)] px-4 py-2 rounded-full shadow-md text-center
        ...
        flex items-center justify-center"
          >
            SIGNUP
					...
					<Link
						href="#"
						className="bg-[linear-gradient(135deg,#28B849_0%,#26621E_100%)]
        w-full
